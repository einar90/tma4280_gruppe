...
A FLOP (Floating Point Operation) is according to Wikipedia adding or multiplying two floating point numbers. When generating our vector we first multiply two integers, then divide 1.0 by the result. This is zero floating point operations.
...
\end{quote}
Under this assumption, we use $4 \times n$ FLOPs to initialize $\mathbf{v}$.
